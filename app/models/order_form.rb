class OrderForm
  ...
  with_options presence: true do
    validates :user_id
    validates :item_id
    validates :post_code, fomat: { with: /\A[0-9]{3}-[0-9]{4}\z/, message: 'is invalid. Include hyphen(-)' }
    validates :prefecture_id, numercality: { other_than: 0, message: "can't be blank" }
    validates :city
    validates :address
